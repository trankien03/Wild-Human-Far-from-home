...
public class TouchingDirectionForPlayer : MonoBehaviour
{
    ...
    private Vector2 wallCheckDritection => gameObject.transform.rotation.y == 0f ? Vector2.right : Vector2.left;
